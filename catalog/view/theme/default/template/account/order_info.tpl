    ...
    <table class="list">
      <thead>
        <tr>
          ...
          <td />
          <td class="left"><?= $textOrderItemId ?></td>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="left"><?= $product['order_product_id'] ?></td>
...
<?php endforeach; ?>
      ...
      <tfoot>
        ...
        <tr>
          <td class="right" colspan="7"><b><?php echo $total['title']; ?>:</b></td>
    ...
    <!--div class="buttons">
      <div class="right"><?php echo $text_action; ?>
        <select name="action" onchange="$('#order').submit();">
          ...
          <?php /*<option value="return"><?php echo $text_return; ?></option> */ ?>
        </select>
      </div>
    </div-->
  </form>
  ...
  <table class="list">
    <thead>
      <tr>
        ...
        <td class="left"><?php echo $textComment; ?></td>
      </tr>
    </thead>
    <tbody>
