...
<div id="content">
  ...
  <div class="content">
    ...
    <div class="right" style="width: 90px; position: relative; top: -45px;">
  ...
  <?php if ($products) { ?>
  <div class="box-heading"><?php echo $heading_title; ?>: <?php echo $filter_name; ?></div>
