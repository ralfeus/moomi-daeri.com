    ...
    <div class="right">
        ...
        <div class="options">
            ...
            <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
                ...
                <?php } ?>
                <b><?php echo $option['name']; ?>:</b><br />
                <input type="text" name="option[<?= $option['product_option_id'] ?>]" value="<?= $option['option_value'] ?>" size="100" />
            </div>
            <br />
            <?php } ?>
            ...
            <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
                ...
                <?php } ?>
                <b><?php echo $option['name']; ?>:</b><br />
                <textarea name="option[<?php echo $option['product_option_id']; ?>]" cols="70" rows="5"><?php echo $option['option_value']; ?></textarea>
            </div>
            <br />
            <?php } ?>
        ...
        <div class="cart">
            <div><?php echo $text_qty; ?>
                ...
                <a onclick="addToWishList('<?php echo $product_id; ?>');" class="button"><span><?php echo $button_wishlist; ?></span></a></div>
            <?php if ($minimum > 1) { ?>
