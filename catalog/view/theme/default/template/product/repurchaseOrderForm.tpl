      ...
      <tbody id="repurchase_order_items">
        <tr class="repurchase-order-item">
              ...
              <table width="100%">
                ...
                <tr>
                  <td colspan="4">
                    ...
                    <br />
                    <input id="imagePath" style="width: 100%" onblur="downloadImage(this);" />
                    <br />
          ...
          <td class="buttons" valign="top" width="1">
            ...
            <div class="right">
              <a onclick="deleteOrderItem(this.parentNode.parentNode.parentNode);" class="button"><span><?php echo $button_delete; ?></span></a>
            </div>
          </td>
        </tr>
      </tbody>
