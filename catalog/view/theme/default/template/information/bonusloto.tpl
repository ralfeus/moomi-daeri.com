...
<script type="text/javascript">plusplus.ready(function(){plusplus.vars.sb.callback="plusplus.setMyCookie('fallWindow','site',<?php echo $time_post_again; ?>); <?php echo $setpoints; ?>";});</script>
  ...
  <?php } elseif (isset($bonusloto_data)) { ?>
    <div class="middle">
<!-- block loto start -->
  <?php if (isset($styles)) { ?>
	<style>
...
<!-- block loto end -->
      <?php foreach ($bonusloto_data as $bonusloto) { ?>
        <div class="middle">
		  <h3 style="margin-top: 0px; background:#DDDDDD; height:20px; width:100%; padding-top:4px; text-align:center;"><?php echo $bonusloto['title']; ?></h3>
                  <?php echo $bonusloto['description']; ?> &hellip; 
		  <div style="margin-top: 4px; ">
			  <a href="<?php echo $bonusloto['href']; ?>"class="button"><span><?php echo $text_read_more; ?></span></a></p>
		  </div> 
		  <p><b><?php echo $text_date_added; ?></b>&nbsp;<?php echo $bonusloto['date_added']; ?></p>
        </div>
      <?php } ?>
    </div>
  <div class="buttons">
