...
class ModelGalleryPhoto extends Model {
	public function addPhoto($data) {
		...
		$this->getDb()->query("INSERT INTO gallery_photo SET customer_id = " . $this->customer->getId() . ", name = '" . $data['name'] . "', `description` = '" . $data['description'] . "', `path` = '" . $data['path'] . "', uploaded_at = '" . $data['date'] . "'");
