...
$_['CURRENCY'] ='Валюты';
$_['EXPENSE_AMOUNT'] = 'Расход (заказы)';
$_['FILTER'] = 'Фильтровать';
$_['GALLERY'] = 'Галерея';
$_['INCOME_AMOUNT'] = 'Приход (оплата)';
...
$_['text_gifts_for_photos'] = 'За добавление фотографий у нас предусмотрены подарочки!';
