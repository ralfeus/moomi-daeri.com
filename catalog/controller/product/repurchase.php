...
//        $this->data['action'] = $this->url->link('product/repurchaseOrder/createOrder', '', 'SSL');
        ...
        $this->data['entry_image_path_help'] = $this->language->get('IMAGE_PATH_HELP');
        $this->data['entry_image_url_help'] = $this->language->get('IMAGE_URL_HELP');
        $this->data['entry_item_url'] = $this->language->get('ITEM_URL');
        $this->data['entry_item_url_help'] = $this->language->get('ITEM_URL_HELP');
        $this->data['entry_name_product_help'] = $this->language->get('NAME_PRODUCT_HELP');
        $this->data['entry_name_shop_help'] = $this->language->get('NAME_SHOP_HELP');
        ...
        $this->data['entry_size_help'] = $this->language->get('SIZE_HELP');
        $this->data['entry_color_help'] = $this->language->get('COLOR_HELP');
        $this->data['entry_quantity_help'] = $this->language->get('QUANTITY_HELP');
        $this->data['entry_price_help'] = $this->language->get('PRICE_HELP');
        $this->data['entry_comments_help'] = $this->language->get('COMMENTS_HELP');
