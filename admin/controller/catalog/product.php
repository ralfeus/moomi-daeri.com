...
//		} else {
	...
	private function getList() {
		...
		$this->getResponse()->setOutput($this->render('catalog/product_list.tpl.php'));
	}
	...
	private function getForm() {
		...
		if($this->getConfig()->get('wk_auction_timezone_set')){
			...
			if (isset($this->request->get['product_id'])) {
				$product_auctions = ProductDAO::getInstance()->getAuctions($this->getRequest()->getParam('product_id'));
