...
class ControllerShippingRoyalMail extends Controller {
	...
	public function index() {   
		...
		} elseif ($this->getConfig()->has('royal_mail_1st_class_standard_rate')) {
			$this->data['royal_mail_1st_class_standard_rate'] = $this->getConfig()->get('royal_mail_1st_class_standard_rate');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_1st_class_standard_insurance')) {
			$this->data['royal_mail_1st_class_standard_insurance'] = $this->getConfig()->get('royal_mail_1st_class_standard_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_1st_class_standard_status'])) {
			...
			$this->data['royal_mail_1st_class_standard_status'] = $this->getConfig()->get('royal_mail_1st_class_standard_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_1st_class_recorded_rate')) {
			$this->data['royal_mail_1st_class_recorded_rate'] = $this->getConfig()->get('royal_mail_1st_class_recorded_rate');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_1st_class_recorded_insurance')) {
			$this->data['royal_mail_1st_class_recorded_insurance'] = $this->getConfig()->get('royal_mail_1st_class_recorded_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_1st_class_recorded_status'])) {
			...
			$this->data['royal_mail_1st_class_recorded_status'] = $this->getConfig()->get('royal_mail_1st_class_recorded_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_2nd_class_standard_rate')) {
			$this->data['royal_mail_2nd_class_standard_rate'] = $this->getConfig()->get('royal_mail_2nd_class_standard_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_2nd_class_standard_status'])) {
			...
			$this->data['royal_mail_2nd_class_standard_status'] = $this->getConfig()->get('royal_mail_2nd_class_standard_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_2nd_class_recorded_rate')) {
			$this->data['royal_mail_2nd_class_recorded_rate'] = $this->getConfig()->get('royal_mail_2nd_class_recorded_rate');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_2nd_class_recorded_insurance')) {
			$this->data['royal_mail_2nd_class_recorded_insurance'] = $this->getConfig()->get('royal_mail_2nd_class_recorded_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_2nd_class_recorded_status'])) {
			...
			$this->data['royal_mail_2nd_class_recorded_status'] = $this->getConfig()->get('royal_mail_2nd_class_recorded_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_special_delivery_500_rate')) {
			$this->data['royal_mail_special_delivery_500_rate'] = $this->getConfig()->get('royal_mail_special_delivery_500_rate');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_special_delivery_500_insurance')) {
			$this->data['royal_mail_special_delivery_500_insurance'] = $this->getConfig()->get('royal_mail_special_delivery_500_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_special_delivery_500_status'])) {
			...
			$this->data['royal_mail_special_delivery_500_status'] = $this->getConfig()->get('royal_mail_special_delivery_500_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_special_delivery_1000_rate')) {
			$this->data['royal_mail_special_delivery_1000_rate'] = $this->getConfig()->get('royal_mail_special_delivery_1000_rate');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_special_delivery_1000_insurance')) {
		...
		if (isset($this->request->post['royal_mail_special_delivery_1000_status'])) {
			...
			$this->data['royal_mail_special_delivery_1000_status'] = $this->getConfig()->get('royal_mail_special_delivery_1000_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_special_delivery_2500_rate')) {
			$this->data['royal_mail_special_delivery_2500_rate'] = $this->getConfig()->get('royal_mail_special_delivery_2500_rate');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_special_delivery_2500_insurance')) {
			$this->data['royal_mail_special_delivery_2500_insurance'] = $this->getConfig()->get('royal_mail_special_delivery_2500_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_special_delivery_2500_status'])) {
			...
			$this->data['royal_mail_special_delivery_2500_status'] = $this->getConfig()->get('royal_mail_special_delivery_2500_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_standard_parcels_rate')) {
			$this->data['royal_mail_standard_parcels_rate'] = $this->getConfig()->get('royal_mail_standard_parcels_rate');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_standard_parcels_insurance')) {
			$this->data['royal_mail_standard_parcels_insurance'] = $this->getConfig()->get('royal_mail_standard_parcels_insurance');		
		} else {
		...
		if (isset($this->request->post['royal_mail_standard_parcels_status'])) {
			...
			$this->data['royal_mail_standard_parcels_status'] = $this->getConfig()->get('royal_mail_standard_parcels_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_airmail_rate_1')) {
			$this->data['royal_mail_airmail_rate_1'] = $this->getConfig()->get('royal_mail_airmail_rate_1');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_airmail_rate_2')) {
			$this->data['royal_mail_airmail_rate_2'] = $this->getConfig()->get('royal_mail_airmail_rate_2');
		} else {
		...
		if (isset($this->request->post['royal_mail_airmail_status'])) {
			...
			$this->data['royal_mail_airmail_status'] = $this->getConfig()->get('royal_mail_airmail_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_international_signed_rate_1')) {
			$this->data['royal_mail_international_signed_rate_1'] = $this->getConfig()->get('royal_mail_international_signed_rate_1');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_international_signed_insurance_1')) {
			$this->data['royal_mail_international_signed_insurance_1'] = $this->getConfig()->get('royal_mail_international_signed_insurance_1');
		} else {
		...
		if (isset($this->request->post['royal_mail_international_signed_rate_2'])) {
			...
			$this->data['royal_mail_international_signed_rate_2'] = $this->getConfig()->get('royal_mail_international_signed_rate_2');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_international_signed_insurance_2')) {
			$this->data['royal_mail_international_signed_insurance_2'] = $this->getConfig()->get('royal_mail_international_signed_insurance_2');
		} else {
		...
		if (isset($this->request->post['royal_mail_international_signed_status'])) {
			...
			$this->data['royal_mail_international_signed_status'] = $this->getConfig()->get('royal_mail_international_signed_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_airsure_rate_1')) {
			$this->data['royal_mail_airsure_rate_1'] = $this->getConfig()->get('royal_mail_airsure_rate_1');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_airsure_insurance_1')) {
			$this->data['royal_mail_airsure_insurance_1'] = $this->getConfig()->get('royal_mail_airsure_insurance_1');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_airsure_rate_2')) {
			$this->data['royal_mail_airsure_rate_2'] = $this->getConfig()->get('royal_mail_airsure_rate_2');
		} else {
		...
		} elseif ($this->getConfig()->has('royal_mail_airsure_insurance_2')) {
			$this->data['royal_mail_airsure_insurance_2'] = $this->getConfig()->get('royal_mail_airsure_insurance_2');
		} else {
		...
		if (isset($this->request->post['royal_mail_airsure_status'])) {
			...
			$this->data['royal_mail_airsure_status'] = $this->getConfig()->get('royal_mail_airsure_status');
		}
		...
		} elseif ($this->getConfig()->has('royal_mail_surface_rate')) {
			$this->data['royal_mail_surface_rate'] = $this->getConfig()->get('royal_mail_surface_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_surface_status'])) {
			...
			$this->data['royal_mail_surface_status'] = $this->getConfig()->get('royal_mail_surface_status');
		}
		...
		if (isset($this->request->post['royal_mail_display_weight'])) {
			...
			$this->data['royal_mail_display_weight'] = $this->getConfig()->get('royal_mail_display_weight');
		}
		...
		if (isset($this->request->post['royal_mail_display_insurance'])) {
			...
			$this->data['royal_mail_display_insurance'] = $this->getConfig()->get('royal_mail_display_insurance');
		}
		...
		if (isset($this->request->post['royal_mail_weight_class_id'])) {
			...
			$this->data['royal_mail_weight_class_id'] = $this->getConfig()->get('royal_mail_weight_class_id');
		}
		...
		if (isset($this->request->post['royal_mail_tax_class_id'])) {
			...
			$this->data['royal_mail_tax_class_id'] = $this->getConfig()->get('royal_mail_tax_class_id');
		}
