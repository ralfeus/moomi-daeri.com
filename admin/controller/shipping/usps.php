...
class ControllerShippingUsps extends \system\engine\Controller {
	private $error = array();
	...
	public function index() {
		...
		if (isset($this->request->post['usps_container'])) {
			...
			$this->data['usps_container'] = $this->getConfig()->get('usps_container');
		}
