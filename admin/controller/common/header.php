...
class Header extends Controller {
    protected function index() {
        ...
        $this->data['text_sql_exec'] = $this->language->get('text_sql_exec');
        ...
        $this->data['text_order_items'] = $this->language->get('text_order_items');
        $this->data['text_order_items_processing'] = $this->language->get('text_order_items_processing');
        ...
        $this->data['textImportModules'] = $this->language->get('IMPORT_MODULES');
        ...
        if (!$this->user->isLogged() || !isset($_REQUEST['token']) || !isset($this->session->data['token']) || ($_REQUEST['token'] != $this->session->data['token'])) {
            ...
            $this->data['creditManagementUrl'] = $this->url->link('sale/creditManagement', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['sql_exec'] = $this->url->link('module/sqlexecutor', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['gallery_voting'] = $this->url->link('gallery/admin/adminVote', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['repurchaseOrders'] = $this->url->link('sale/repurchaseOrders', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['supplier_group'] = $this->url->link('catalog/supplier_group', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['urlImportModules'] = $this->url->link('extension/import', 'token=' . $this->session->data['token'], 'SSL');
