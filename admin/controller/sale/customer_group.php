...
class ControllerSaleCustomerGroup extends Controller {
	...
	private function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['customer_groups'][] = array(
                ...
                'allowOverdraft' => $result['allow_overdraft'] ? 'true' : 'false',
                'awaitInvoiceConfirmation' => $result['await_invoice_confirmation'] ? 'true' : 'false',
        ...
        $this->data['textAllowOverdraft'] = $this->language->get('ALLOW_OVERDRAFT');
        $this->data['textAwaitInvoiceConfirmation'] = $this->language->get('AWAIT_INVOICE_CONFIRMATION');
	...
	private function getForm() {
        ...
        if (isset($this->request->post['allowOverdraft']))
            $this->data['allowOverdraft'] = $this->request->post['allowOverdraft'];
        elseif (isset($customer_group_info))
            $this->data['allowOverdraft'] = $customer_group_info['allow_overdraft'];
        else
            $this->data['allowOverdraft'] = false;

        if (isset($this->request->post['awaitInvoiceConfirmation']))
            $this->data['awaitInvoiceConfirmation'] = $this->request->post['awaitInvoiceConfirmation'];
        elseif (isset($customer_group_info))
            $this->data['awaitInvoiceConfirmation'] = $customer_group_info['await_invoice_confirmation'];
        else
            $this->data['awaitInvoiceConfirmation'] = true;
