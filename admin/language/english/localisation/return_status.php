<?php
// Heading
$_['heading_title']    = 'Return system\library\Status';

// Text
$_['text_success']     = 'Success: You have modified return statuses!';

// Column
$_['column_name']      = 'Return system\library\Status Name';
$_['column_action']    = 'Action';

// Entry
$_['entry_name']       = 'Return system\library\Status Name:';

// Error
$_['error_permission'] = 'Warning: You do not have permission to modify return statues!';
$_['error_name']       = 'Return system\library\Status Name must be between 3 and 32 characters!';
