...
<?php endforeach; ?>
                ...
                <table class="list">
                    ...
                    <tbody>
                        <?php foreach ($orderItems as $order_item): ?>
                            <input name="selectedItems[]" type="hidden" value="<?= $order_item['id'] ?>" />
                            <tr>
                                <td class="right"><?= $order_item['id']; ?></td>
                                <td class="right"><?= $order_item['order_id'] ?></td>
                                ...
                                <td class="right">
                                    <table height="100%" width="100%" class="list">
                                        ...
                                        <tr><td class="left"><span style="color: red;"><?= nl2br($order_item['options']) ?></span></td></tr>
                                    </table>
                                </td>
