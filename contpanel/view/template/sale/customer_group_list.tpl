        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'name') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?= $textAllowOverdraft ?></td>
              <td class="left"><?= $textAwaitInvoiceConfirmation ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?= $customer_group['allowOverdraft'] ?></td>
              <td class="left"><?= $customer_group['awaitInvoiceConfirmation'] ?></td>
