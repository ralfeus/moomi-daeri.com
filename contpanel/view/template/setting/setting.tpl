      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-option">
          <table class="form">
            ...
            <tr>
                <td><?php echo $entry_product_hotness_age; ?></td>
                <td><input name="config_product_hotness_age" value="<?php echo $config_product_hotness_age; ?>" /></td>
            </tr>
          </table>
        </div>
        <div id="tab-image">
        ...
        <div id="tab-server">
          <table class="form">
            ...
            <tr>
              ...
              <tr>
                  <td><?= $textYandexCounterCode ?></td>
                  <td><textarea name="config_YandexCounterCode" cols="40" rows="5"><?= $config_YandexCounterCode ?></textarea></td>
              </tr>
          </table>
        </div>
      </form>
