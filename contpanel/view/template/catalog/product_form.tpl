        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" id="Calculator" name="price" value="<?php echo $price; ?>" /></td>
            </tr>
            <tr>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="right"><input type="text" id="Calculator" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo $product_special['price']; ?>" /></td>
...
function addSpecial() {
	...
	html += '    <td class="right"><input type="text" class="specCalculator" name="product_special[' + special_row + '][price]" /></td>';
