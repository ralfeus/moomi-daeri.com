                ...
                <table class="list">
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <?php if ($supplier_group['selected']): ?>
                                <input type="checkbox" name="selected[]" value="<?php echo $supplier_group['supplier_group_id']; ?>" checked="checked" />
                            <?php else: ?>
                                <input type="checkbox" name="selected[]" value="<?php echo $supplier_group['supplier_group_id']; ?>" />
                            <?php endif; ?>
                        </td>
